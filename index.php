  ...
  <section class="about-section">
    <div class="container">
      <div class="row justify-content-center align-items-center top-head">
        <div class="col-lg-6 mb-4 mb-lg-0 position-relative">
          <div class="box-about-img">
            <div class="about-img">
              <img src="assets/images/about01.jpg" alt="ảnh 1" class="img-fluid rounded shadow">
            </div>
            <div class="about-img">
              <img src="assets/images/about02.jpg" alt="ảnh 2" class="img-fluid rounded shadow">
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="about-content">
            ...
            <a href="#" class="btn-aboutus text-orange text-decoration-none">Về chúng tôi <img src="assets/images/icons/i-arrow-right.svg" alt="arrow-right" class="img-fluid" width="16"></a>
          </div>
        </div>
      </div>
      ...
      <div class="row text-center mt-5 stats-row">
        ...
        <div class="col-md-4 mb-4">
          <img src="assets/images/icons/i-steel-beam.svg" alt="Sản lượng" class="mb-4" style="height: 120px;">
          <h4><span class="count-number" data-target="10000">0</span>+</h4>
          <p class="mb-0">Sản lượng thép<br>hàng năm</p>
        </div>
        <div class="col-md-4 mb-4">
          <img src="assets/images/icons/i-target.svg" alt="Khách hàng" class="mb-4" style="height: 120px;">
      ...
      <div class="row align-items-center">
        <div class="col-md-5 mb-4">
          <div class="product-main-img">
            <img src="assets/images/sanpham.jpg" alt="Sản phẩm" class="img-fluid shadow">
          </div>
        </div>
        <div class="col-md-7">
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4">
          <div class="service-box active">
            ...
            <div class="description">
              ...
              <a href="#"><img src="assets/images/icons/i-arrow-right-blue.svg" alt="arrow blue" class="img-fluid" width="22"></a>
            </div>
            <a href="#" class="custom-btn">
              THIẾT KẾ <img src="assets/images/icons/i-arrow-right-white.svg" alt="arrow white" class="img-fluid" width="22">
            </a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            <div class="image-box">
              <img src="assets/images/dichvu.jpg" class="img-fluid w-100 h-100 object-cover" alt="Gia công">
            </div>
            <div class="description">
            ...
            <a href="#" class="custom-btn">
              GIA CÔNG <img src="assets/images/icons/i-arrow-right-white.svg" alt="arrow white" class="img-fluid" width="22">
            </a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="service-box">
            <div class="image-box">
              <img src="assets/images/dichvu.jpg" class="img-fluid w-100 h-100 object-cover" alt="Lắp dựng">
            </div>
            <div class="description">
            ...
            <a href="#" class="custom-btn">
              Lắp dựng <img src="assets/images/icons/i-arrow-right-white.svg" alt="arrow white" class="img-fluid" width="22">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <a href="#" class="btn-xemtatca fw-medium text-decoration-none">Xem tất cả
          <img src="assets/images/icons/i-arrow-all.svg" alt="Xem tất cả" width="16">
        </a>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="project-card">
            <div class="project-card-img">
              <a href="#"><img src="assets/images/duan01.jpg" class="img-fluid" alt="Dự án"></a>
            </div>
            <a href="#" class="project-title">
              <strong>TÊN DỰ ÁN</strong>
              <img src="assets/images/icons/i-arrow-right-blue.svg" alt="arrow-right" class="img-fluid" width="22">
            </a>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="project-card">
            <div class="project-card-img">
              <a href="#"><img src="assets/images/duan02.jpg" class="img-fluid" alt="Dự án"></a>
            </div>
            <a href="#" class="project-title">
              <strong>TÊN DỰ ÁN</strong>
              <img src="assets/images/icons/i-arrow-right-blue.svg" alt="arrow-right" class="img-fluid" width="22">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="project-card">
            <div class="project-card-img">
              <a href="#"><img src="assets/images/duan03.jpg" class="img-fluid" alt="Dự án"></a>
            </div>
            <a href="#" class="project-title">
              <strong>TÊN DỰ ÁN</strong>
              <img src="assets/images/icons/i-arrow-right-blue.svg" alt="arrow-right" class="img-fluid" width="22">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="carousel" data-flickity='{ "groupCells": true, "pageDots": false }'>
            <div class="carousel-cell">
              <a href="#"><img class="img-fluid" src="assets/images/doitac01.png" alt="đối tác"></a>
            </div>
            <div class="carousel-cell">
              <a href="#"><img class="img-fluid" src="assets/images/doitac02.png" alt="đối tác"></a>
            </div>
            <div class="carousel-cell">
              <a href="#"><img class="img-fluid" src="assets/images/doitac01.png" alt="đối tác"></a>
            </div>
        ...
        <div class="col-12 col-lg-5 mb-4">
          <div class="highlight-news">
            ...
            <div class="highlight-news-img">
              <!-- <img src="assets/images/duan01.jpg" alt="du an" class="img-fluid"> -->
            </div>
          ...
          <div class="border-start border-light ps-lg-4 ps-3">
            ...
            <div class="news-item d-flex align-items-start mb-4">
              ...
              <div>
                ...
                <a href="#"><span class="arrow-icon text-white"><img src="assets/images/icons/i-arrow-right-white.svg" alt="arrow" class="img-fluid"></span></a>
              </div>
            </div>
